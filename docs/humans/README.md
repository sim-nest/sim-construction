...
| `feature/sim-construction/production-field-control` | `crate/sim-lib-construction-project` | 2 | Control every construction field item, incident, and quality condition, including Dalux-linked observations, deviations, inspection and test points, defects, and corrective actions, with accountable evidence and safety-first rollups. |
