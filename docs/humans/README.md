...
| `feature/sim-construction/project-control` | `crate/sim-lib-construction-project` | 3 | Describe construction as-of snapshot records, project charter identity, append-only fact books, deterministic deltas, governance, capabilities, and readiness with reference-only evidence. |
