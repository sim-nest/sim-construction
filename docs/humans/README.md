...
| `feature/sim-construction/office-evidence-bridge` | `crate/sim-lib-construction-office` | 2 | Attach project-scoped construction fact evidence to existing office documents while preserving precise construction meaning, visibility, and acceptance. |
