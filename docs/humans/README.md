...
| `feature/sim-construction/office-role-cadence-packs` | `crate/sim-lib-construction-office` | 1 | Project current or historical construction snapshots into deterministic, evidence-linked, visibility-safe role-cadence packs on existing office surfaces. |
...
| `feature/sim-construction/phase-gates` | `crate/sim-lib-construction-project` | 3 | Derive construction phase gate baseline and obligation readiness from accepted project-control facts while keeping human approval and exceptions as separate accountable decisions. |
